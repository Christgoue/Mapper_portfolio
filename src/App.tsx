        ...
        <div className="flex gap-x-1 px-8 pt-4 border-b theme-border theme-bg-elevated">
          {tabs.map((tab) => (
            <button
              ...
              className={`flex items-center gap-x-2 px-5 py-3 text-sm border-b-2 -mb-px transition-all ${activeTab === tab.id
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {COLORS.map((c) => (
                    <button
                      ...
                      className={`h-9 w-9 rounded-2xl border-2 transition-all ${draft.color === c ? 'border-white scale-110 shadow-lg' : 'border-transparent hover:scale-105'
                        }`}
